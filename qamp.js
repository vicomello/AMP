	...
	**/
	...
	function ampExtension(options)
	{
		...
		var ampObj = 
		{
		    ...
		    targetCat : 'Pictograph', //The name of the targets (used in the instructions)
			...
			' The second image is a character (Pictograph) from an ancient alphabet. Your job is to make a quick judgement on how pleasant each drawing is. ' +
			...
			'It is important to note that the real-life images can sometimes bias people \'s judgments of the characters. ' +
			...
			'<p style="font-size:16px; text-align:center; font-family:arial"><color="000000"><br/><br/>' + 
			'Ready? You will now begin the real trials. Please place your fingers on the response keys, (e and i) and hit the <b>space bar</b> to begin.</p> ' + 
			'<p style="font-size:12px; text-align:center; font-family:arial">' + 
